...
![Connected departure map](docs/public/terminal-map.png)
...
|---|---|
| Data ingestion | Six versioned packs plus a scoped equipment observation API; checksummed inputs, source identity mapping, duplicate/stale/conflict handling |
...
Read [the walkthrough](docs/public/walkthrough.md), [architecture](docs/public/architecture.md), [dataset contracts](datasets/README.md), [equipment integration](docs/public/integration.md) and [deployment/recovery](docs/public/deployment.md).
